...
#    'ccpp/physics/physics/gfdl_sfc_layer.F90'               : ['physics'],
    ...
    'ccpp/physics/physics/module_SGSCloud_RadPre.F90'       : ['physics'],
    'ccpp/physics/physics/module_SGSCloud_RadPost.F90'      : ['physics'],
    ...
    'ccpp/physics/physics/phys_tend.F90'                    : ['physics'],
