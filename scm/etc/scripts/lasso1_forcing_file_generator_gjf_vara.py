...
nc_fid_ls  = Dataset("../../data/raw_case_input/LASSO_20160518_VARA/input_ls_forcing.nc", 'r')
nc_fid_sfc = Dataset("../../data/raw_case_input/LASSO_20160518_VARA/input_sfc_forcing.nc", 'r')
nc_fid_wrf = Dataset("../../data/raw_case_input/LASSO_20160518_VARA/wrfinput_d01.nc", 'r')
...
file_out="../../data/processed_case_input/LASSO_"+year+mon+day+hour+"_VARA.nc"
