...
nc_fid = Dataset("../../data/raw_case_input/MOSAiC_31Oct20190Z_raw.nc", 'r')
...
thetail = nc_fid.variables['thetail'][:] #theta_il (time, lev)
thetail = np.swapaxes(thetail, 0, 1)
#use unpstream theta instead of thetail
thetailu = nc_fid.variables['thetailu'][:] #theta (time, lev)
