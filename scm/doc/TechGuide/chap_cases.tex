...
NOTE: If using NOAA's Hera HPC, the \execout{shapely} python package does not seem to be installed with the version of Anaconda used by the rest of this software package. Users can test if \execout{shapely} is installed using this command in the shell:
\begin{lstlisting}
...
\begin{lstlisting}
cd scm/etc/scripts/Shapely-1.7.0/
