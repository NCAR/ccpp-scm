...
\item \execout{C\_RES}
	...
	\end{itemize}
\item \execout{input_type}
        \begin{itemize}
        \itemFile  0 => original DTC format, 1 => DEPHY-SCM format.
        \end{itemize}
\end{itemize}
