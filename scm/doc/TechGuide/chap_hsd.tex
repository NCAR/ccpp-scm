...
The scripts here require a few python packages that may not be found by default in all python installations. There is a YAML file with the python environment needed to run the script in \execout{ccpp-scm/scm\_suite\_sim.yml}. To create and activate this environment using conda:
...
./create_2D_CSSdata.py --cases twpice --suites SCM_GFS_v17_p8
\end{lstlisting}
