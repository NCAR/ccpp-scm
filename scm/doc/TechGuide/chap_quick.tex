...
\end{lstlisting}
If the download step fails, make sure that your system's firewell does not block access to GitHub. If it does, download the file \execout{thompson_tables.tar} from the GitHub release website and manually extract its contents in the directory \execout{scm/data/physics_input_data/}.
