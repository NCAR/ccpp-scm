...
\begin{lstlisting}
export bacio_ROOT=/path/to/nceplibs/lib/libbacio_4.a
export sp_ROOT=/path/to/nceplibs/lib/libsp_d.a
export w3nco_ROOT=/path/to/nceplibs/lib/libw3nco_d.a
\end{lstlisting}
and for t/csh
\begin{lstlisting}
setenv bacio_ROOT /path/to/nceplibs/lib/libbacio_4.a
setenv sp_ROOT /path/to/nceplibs/lib/libsp_d.a
setenv w3nco_ROOT /path/to/nceplibs/lib/libw3nco_d.a
\end{lstlisting}
