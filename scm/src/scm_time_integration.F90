...
subroutine do_time_step(scm_state, physics, cdata, in_spinup)
  ...
  !if no physics call, need to transfer state_variables(:,:) to state_variables (:,:,2)
  ! scm_state%state_T(:,:,2) = scm_state%state_T(:,:)
  ! scm_state%state_tracer(:,:,:,2) = scm_state%state_tracer(:,:,:)
  ! scm_state%state_u(:,:,2) = scm_state%state_u(:,:)
  ! scm_state%state_v(:,:,2) = scm_state%state_v(:,:)
