...
subroutine output_init(scm_state, physics)
  ...
  CALL CHECK(NF90_PUT_ATT(NCID=ncid,VARID=dummy_id,NAME="units",VALUES="m2 s-1"))
  CALL CHECK(NF90_DEF_VAR(NCID=ncid,NAME='upward_mass_flux_of_air_due_to_subgrid_scale_vertical_mixing',XTYPE=NF90_FLOAT,DIMIDS= (/ hor_dim_id, vert_dim_id, time_id /), VARID=dummy_id))
  CALL CHECK(NF90_PUT_ATT(NCID=ncid,VARID=dummy_id,NAME="description",VALUES="upward mass flux calculated in the mass flux-based PBL scheme"))
  CALL CHECK(NF90_PUT_ATT(NCID=ncid,VARID=dummy_id,NAME="units",VALUES="kg m-2 s-1"))
  CALL CHECK(NF90_DEF_VAR(NCID=ncid,NAME='subgrid_scale_vertical_flux_of_potential_temperature',XTYPE=NF90_FLOAT,DIMIDS= (/ hor_dim_id, vert_dim_id, time_id /), VARID=dummy_id))
  CALL CHECK(NF90_PUT_ATT(NCID=ncid,VARID=dummy_id,NAME="description",VALUES="subgrid-scale vertical flux of potential temperature from PBL scheme"))
  CALL CHECK(NF90_PUT_ATT(NCID=ncid,VARID=dummy_id,NAME="units",VALUES="K m s-1"))
  CALL CHECK(NF90_DEF_VAR(NCID=ncid,NAME='subgrid_scale_vertical_flux_of_specific_humidity',XTYPE=NF90_FLOAT,DIMIDS= (/ hor_dim_id, vert_dim_id, time_id /), VARID=dummy_id))
  CALL CHECK(NF90_PUT_ATT(NCID=ncid,VARID=dummy_id,NAME="description",VALUES="subgrid-scale vertical flux of specific humidity from PBL scheme"))
  CALL CHECK(NF90_PUT_ATT(NCID=ncid,VARID=dummy_id,NAME="units",VALUES="kg kg-1 m s-1"))
  CALL CHECK(NF90_DEF_VAR(NCID=ncid,NAME='subgrid_scale_vertical_flux_of_x_wind',XTYPE=NF90_FLOAT,DIMIDS= (/ hor_dim_id, vert_dim_id, time_id /), VARID=dummy_id))
  CALL CHECK(NF90_PUT_ATT(NCID=ncid,VARID=dummy_id,NAME="description",VALUES="subgrid-scale vertical flux of x-wind from PBL scheme"))
...
subroutine output_append(scm_state, physics)
  ...
  CALL CHECK(NF90_INQ_VARID(NCID=ncid,NAME="upward_mass_flux_of_air_due_to_subgrid_scale_vertical_mixing",VARID=var_id))
  CALL CHECK(NF90_PUT_VAR(NCID=ncid,VARID=var_id,VALUES=physics%Interstitial%mflx_pbl(:,:),START=(/1,1,scm_state%itt_out /)))
  CALL CHECK(NF90_INQ_VARID(NCID=ncid,NAME="subgrid_scale_vertical_flux_of_potential_temperature",VARID=var_id))
  CALL CHECK(NF90_PUT_VAR(NCID=ncid,VARID=var_id,VALUES=physics%Interstitial%sgs_vert_flx_th(:,:),START=(/1,1,scm_state%itt_out /)))
  CALL CHECK(NF90_INQ_VARID(NCID=ncid,NAME="subgrid_scale_vertical_flux_of_specific_humidity",VARID=var_id))
  CALL CHECK(NF90_PUT_VAR(NCID=ncid,VARID=var_id,VALUES=physics%Interstitial%sgs_vert_flx_q(:,:),START=(/1,1,scm_state%itt_out /)))
  CALL CHECK(NF90_INQ_VARID(NCID=ncid,NAME="subgrid_scale_vertical_flux_of_x_wind",VARID=var_id))
