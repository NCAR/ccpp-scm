  ...
  subroutine physics_set(physics, scm_input, scm_state)
    ...
    do i = 1, physics%Model%ncols
      ...
      if (scm_state%model_ics .or. scm_state%lsm_ics) then  
        ...
        call conditionally_set_var(int(scm_input%input_vegtyp), physics%Sfcprop%vtype(i), "vegtyp", .true., missing_var(17))
        call conditionally_set_var(int(scm_input%input_soiltyp), physics%Sfcprop%stype(i), "soiltyp", .true., missing_var(18))
        ...
        call conditionally_set_var(int(scm_input%input_slopetype), physics%Sfcprop%slope(i), "slopetyp", .true., missing_var(30))
