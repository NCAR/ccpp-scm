...
subroutine output_init_diag(ncid, time_inst_id, time_diag_id, time_rad_id, hor_dim_id, vert_dim_id, physics)
  ...
  call output_init_tendency(ncid, 'dT_dt_swrad',     "temperature tendency due to longwave radiation scheme", "K s-1", hor_dim_id, vert_dim_id, time_diag_id, physics%Model%dtidx(physics%Model%index_of_temperature,physics%Model%index_of_process_shortwave))
  call output_init_tendency(ncid, 'dT_dt_pbl',       "temperature tendency due to longwave radiation scheme", "K s-1", hor_dim_id, vert_dim_id, time_diag_id, physics%Model%dtidx(physics%Model%index_of_temperature,physics%Model%index_of_process_pbl))
  call output_init_tendency(ncid, 'dT_dt_deepconv',  "temperature tendency due to longwave radiation scheme", "K s-1", hor_dim_id, vert_dim_id, time_diag_id, physics%Model%dtidx(physics%Model%index_of_temperature,physics%Model%index_of_process_dcnv))
  call output_init_tendency(ncid, 'dT_dt_shalconv',  "temperature tendency due to longwave radiation scheme", "K s-1", hor_dim_id, vert_dim_id, time_diag_id, physics%Model%dtidx(physics%Model%index_of_temperature,physics%Model%index_of_process_scnv))
  call output_init_tendency(ncid, 'dT_dt_micro',     "temperature tendency due to longwave radiation scheme", "K s-1", hor_dim_id, vert_dim_id, time_diag_id, physics%Model%dtidx(physics%Model%index_of_temperature,physics%Model%index_of_process_mp))
  call output_init_tendency(ncid, 'dT_dt_ogwd',      "temperature tendency due to longwave radiation scheme", "K s-1", hor_dim_id, vert_dim_id, time_diag_id, physics%Model%dtidx(physics%Model%index_of_temperature,physics%Model%index_of_process_orographic_gwd))
  call output_init_tendency(ncid, 'dT_dt_rayleigh',  "temperature tendency due to longwave radiation scheme", "K s-1", hor_dim_id, vert_dim_id, time_diag_id, physics%Model%dtidx(physics%Model%index_of_temperature,physics%Model%index_of_process_rayleigh_damping))
  call output_init_tendency(ncid, 'dT_dt_cgwd',      "temperature tendency due to longwave radiation scheme", "K s-1", hor_dim_id, vert_dim_id, time_diag_id, physics%Model%dtidx(physics%Model%index_of_temperature,physics%Model%index_of_process_nonorographic_gwd))
  call output_init_tendency(ncid, 'dT_dt_phys',      "temperature tendency due to longwave radiation scheme", "K s-1", hor_dim_id, vert_dim_id, time_diag_id, physics%Model%dtidx(physics%Model%index_of_temperature,physics%Model%index_of_process_physics))
  call output_init_tendency(ncid, 'dT_dt_nonphys',   "temperature tendency due to longwave radiation scheme", "K s-1", hor_dim_id, vert_dim_id, time_diag_id, physics%Model%dtidx(physics%Model%index_of_temperature,physics%Model%index_of_process_non_physics))
